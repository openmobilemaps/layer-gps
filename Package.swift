...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/openmobilemaps/maps-core", from: .upToNextMinor(from: "3.0.0")),
        .package(url: "https://github.com/UbiqueInnovation/ubkit-ios", .upToNextMajor(from: "2.0.0")),
    ],
    targets: [
        .target(
            name: "LayerGps",
